...
function extractAnnotationsFromCode(code, config) {
    const { lines } = code;
    let lineNumber = 1;
    const annotations = [];
    const focusList = [];
...
function getStyle(theme, themeName) {
    return __awaiter(this, void 0, void 0, function* () {
        if (styleCache.has(themeName)) {
            return styleCache.get(themeName);
        }
        const rules = yield getCSSVariables(theme);
...
function getCSSVariables(theme) {
    return __awaiter(this, void 0, void 0, function* () {
        const themeColors = yield lighter.getThemeColors(theme);
...
function addConfig(tree, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const style = yield getStyle(theme, themeName);
        const codeConfig = {
