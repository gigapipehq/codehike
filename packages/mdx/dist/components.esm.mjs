...
function AfterDimensions({ config: { minZoom = 1, maxZoom = 1, horizontalCenter = false, }, dimensions, stepInfo, progress, htmlProps, config, }) {
    ...
    return (React.createElement(Wrapper, { htmlProps: htmlProps, measured: true },
        ...
        config.showCopyButton ? (React.createElement(CopyButton, { className: "ch-code-button", content: (_a = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.code) === null || _a === void 0 ? void 0 : _a.prev, transformContent: config.transformCopyContent })) : undefined));
}
...
function EditorTween(_a) {
    ...
    const northButtons = (React.createElement(React.Fragment, null,
        showCopyButton ? (React.createElement(CopyButton, { className: "ch-editor-button", content: northContent, transformContent: codeConfig.transformCopyContent })) : undefined,
        showExpandButton ? (React.createElement(ExpandButton, { className: "ch-editor-button", step: next || prev })) : undefined));
    const southCopyButton = showCopyButton ? (React.createElement(CopyButton, { className: "ch-editor-button", content: southContent, transformContent: codeConfig.transformCopyContent })) : undefined;
