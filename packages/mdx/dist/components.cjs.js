...
function useDimensions(code, focus, minColumns, lineNumbers, rows, deps) {
    ...
    const [visibility, markAsVisible] = React__default["default"].useState(0);
...
function Lines({ codeStep, progress, focusWidth, lineHeight, startX, lineNumberWidth, }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null, groups.map((group, i) => {
        if (!group.annotation) {
            return (React__default["default"].createElement(LineGroup, { lines: group.lines, t: progress, focusWidth: focusWidth, lineHeight: lineHeight, startX: startX, key: i, lineNumberWidth: lineNumberWidth }));
        }
        ...
        return (React__default["default"].createElement(Component, { style: {
            ...
            React__default["default"].createElement(LineGroup, { lines: group.lines, t: progress, focusWidth: focusWidth, lineHeight: lineHeight, startY: startY, startX: startX, lineNumberWidth: lineNumberWidth })));
    })));
}
...
function AnnotatedTokens({ annotatedGroup, progress, dx, }) {
    ...
    return Component ? (React__default["default"].createElement(Component, { children: children, data: (_b = annotated === null || annotated === void 0 ? void 0 : annotated.annotation) === null || _b === void 0 ? void 0 : _b.data, isInline: true })) : (React__default["default"].createElement(React__default["default"].Fragment, null, children));
}
...
function CopyButton({ content, transformContent, style, className, }) {
    const [copied, setCopied] = React__default["default"].useState(false);
    return (React__default["default"].createElement("button", { type: "button", title: "Copy code", className: className, style: style, onClick: () => {
        ...
        React__default["default"].createElement("svg", { fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, copied ? (React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" })) : (React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.6px", d: "M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" })))));
}
...
function BeforeDimensions({ element, htmlProps, debug, }) {
    return (React__default["default"].createElement(Wrapper, { htmlProps: htmlProps, measured: false }, element));
}
function AfterDimensions({ config: { minZoom = 1, maxZoom = 1, horizontalCenter = false, }, dimensions, stepInfo, progress, htmlProps, config, }) {
    var _a;
    return (React__default["default"].createElement(Wrapper, { htmlProps: htmlProps, measured: true },
        ...
        config.showCopyButton ? (React__default["default"].createElement(CopyButton, { className: "ch-code-button", content: (_a = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.code) === null || _a === void 0 ? void 0 : _a.prev, transformContent: config.transformCopyContent })) : undefined));
}
function Wrapper({ htmlProps, children, measured, }) {
    return (
    // not using <pre> because https://github.com/code-hike/codehike/issues/120
    React__default["default"].createElement("div", Object.assign({}, htmlProps, { className: `ch-code-wrapper ${(htmlProps === null || htmlProps === void 0 ? void 0 : htmlProps.className) || ""}`, "data-ch-measured": measured, children: children })));
}
...
const MiniFrame = React__default["default"].forwardRef(function (_a, ref) {
    ...
    return (React__default["default"].createElement("div", Object.assign({}, props, { ref: ref }),
        React__default["default"].createElement("div", { className: "ch-frame" },
            React__default["default"].createElement("div", { className: "ch-frame-title-bar" }, bar),
            React__default["default"].createElement("div", { className: "ch-frame-content" },
                React__default["default"].createElement("div", { className: "ch-frame-zoom", style: zoomStyle }, children)))));
});
React__default["default"].forwardRef(function (_a, ref) {
    ...
    const bar = titleBar || React__default["default"].createElement(DefaultTitleBar, { title: title });
    return (React__default["default"].createElement("div", Object.assign({}, props, { ref: ref }),
        React__default["default"].createElement("div", { className: "ch-simple-frame" },
            React__default["default"].createElement("div", { className: "ch-frame-title-bar" }, bar),
            children)));
});
function DefaultTitleBar({ title }) {
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: "ch-frame-left-bar" },
            React__default["default"].createElement(FrameButtons, null)),
        React__default["default"].createElement("div", { className: "ch-frame-middle-bar" }, title),
        React__default["default"].createElement("div", { className: "ch-frame-right-bar" })));
}
function FrameButtons() {
    return (React__default["default"].createElement("div", { className: "ch-frame-buttons" },
        React__default["default"].createElement("div", { className: "ch-frame-button ch-frame-button-left" }),
        React__default["default"].createElement("div", { className: "ch-frame-button-space" }),
        React__default["default"].createElement("div", { className: "ch-frame-button ch-frame-button-middle" }),
        React__default["default"].createElement("div", { className: "ch-frame-button-space" }),
        React__default["default"].createElement("div", { className: "ch-frame-button ch-frame-button-right" })));
}
...
const EditorFrame = React__default["default"].forwardRef(function InnerEditorFrame(_a, ref) {
    ...
    return (React__default["default"].createElement("div", Object.assign({ ref: ref }, rest, { className: "ch-editor-frame", style: style }),
        React__default["default"].createElement("div", { className: "ch-frame-title-bar" },
            React__default["default"].createElement(TabsContainer, { tabs: northPanel.tabs, showFrameButtons: true, button: northButton, panel: "north", onTabClick: onTabClick })),
...
function CodeBrowser({ files, startingFileName, }) {
    ...
    return (React__default["default"].createElement("div", { className: "ch-code-browser" },
        React__default["default"].createElement(Sidebar, { files: files, activeFile: activeFile, setActiveFile: setActiveFile }),
        React__default["default"].createElement(Content, { file: activeFile })));
}
function Sidebar({ files, activeFile, setActiveFile, }) {
    const tree = React__default["default"].useMemo(() => toFileTree(files), [files]);
    return (React__default["default"].createElement("div", { className: "ch-code-browser-sidebar" },
...
function SidebarNode({ node, activeFile, setActiveFile, level, }) {
    ...
    if (isFolder) {
        ...
        return (React__default["default"].createElement("div", null,
            React__default["default"].createElement("div", { className: "ch-code-browser-sidebar-file", "data-selected": isSelected, onClick: () => setActiveFile(node.codeFile) },
                React__default["default"].createElement("div", { style: { paddingLeft: level * 1.5 + "ch" } }, node.name))));
    }
}
function Content({ file }) {
    return (React__default["default"].createElement("div", { className: "ch-code-browser-content" },
        React__default["default"].createElement(CopyButton, { className: "ch-code-browser-button", content: codeToText(file.code) }),
        file.code.lines.map((line, i) => (React__default["default"].createElement("div", { key: i },
            line.tokens.map((token, i) => (React__default["default"].createElement("span", Object.assign({ key: i }, token.props), token.content))),
            React__default["default"].createElement("br", null))))));
}
...
function ExpandButton({ style, step, className, }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement("dialog", { ref: ref, className: "ch-expand-dialog", onClose: () => {
            ...
            expanded ? (React__default["default"].createElement("div", { className: "ch-expand-dialog-content" },
                React__default["default"].createElement(CodeBrowser, { files: files, startingFileName: step.northPanel.active }))) : undefined)));
}
function ExpandIcon({ onClick, style, className, }) {
    return (React__default["default"].createElement("button", { type: "button", title: "Expand", style: style, onClick: onClick, className: className },
        React__default["default"].createElement("svg", { fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" },
...
function CloseButton({ onClick }) {
    return (React__default["default"].createElement("button", { onClick: onClick, className: "ch-expand-close", type: "button", title: "Close" },
        React__default["default"].createElement("svg", { fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" },
...
function EditorTween(_a) {
    ...
    const northButtons = (React__default["default"].createElement(React__default["default"].Fragment, null,
        showCopyButton ? (React__default["default"].createElement(CopyButton, { className: "ch-editor-button", content: northContent, transformContent: codeConfig.transformCopyContent })) : undefined,
        showExpandButton ? (React__default["default"].createElement(ExpandButton, { className: "ch-editor-button", step: next || prev })) : undefined));
    const southCopyButton = showCopyButton ? (React__default["default"].createElement(CopyButton, { className: "ch-editor-button", content: southContent, transformContent: codeConfig.transformCopyContent })) : undefined;
    ...
    return (React__default["default"].createElement(EditorFrame, Object.assign({ ref: ref }, framePropsWithHeight, { northPanel: northPanel, southPanel: southPanel, terminalPanel: terminalPanel, northButton: northButtons, southButton: southCopyButton })));
}
...
function mergeCodeConfig(props) {
    ...
    const codeConfig = Object.assign(Object.assign({}, props.codeConfig), { maxZoom: maxZoom == null ? (_a = props.codeConfig) === null || _a === void 0 ? void 0 : _a.maxZoom : maxZoom, minZoom: minZoom == null ? (_b = props.codeConfig) === null || _b === void 0 ? void 0 : _b.minZoom : minZoom, horizontalCenter: (_d = (_c = props.codeConfig) === null || _c === void 0 ? void 0 : _c.horizontalCenter) !== null && _d !== void 0 ? _d : props.horizontalCenter, lineNumbers: lineNumbers == null
            ...
            : showExpandButton, rows: props.rows, debug: (_h = props.debug) !== null && _h !== void 0 ? _h : (_j = props.codeConfig) === null || _j === void 0 ? void 0 : _j.debug, transformCopyContent: props.transformCopyContent });
...
function InnerCode(_a) {
    ...
    if (!props.southPanel &&
        ...
        !props.files[0].name) {
        return (React__default["default"].createElement("div", { className: `ch-codeblock not-prose ${className || ""}`, "data-ch-theme": (_b = props.codeConfig) === null || _b === void 0 ? void 0 : _b.themeName, style: style },
        ...
        return (React__default["default"].createElement("div", { className: `ch-codegroup not-prose ${className || ""}`, "data-ch-theme": (_c = props.codeConfig) === null || _c === void 0 ? void 0 : _c.themeName, style: style },
...
function Back() {
    return (React__default["default"].createElement("svg", { fill: "currentColor", preserveAspectRatio: "xMidYMid meet", height: "1em", viewBox: "13 10 14 23", className: "ch-browser-button ch-browser-back-button" },
...
function Forward() {
    return (React__default["default"].createElement("svg", { fill: "currentColor", preserveAspectRatio: "xMidYMid meet", height: "1em", viewBox: "13 10 14 23", className: "ch-browser-button ch-browser-forward-button" },
        React__default["default"].createElement("g", null,
...
function Open({ href }) {
    return (React__default["default"].createElement("a", { className: "ch-browser-button ch-browser-open-button", title: "Open in new tab", href: href, target: "_blank", rel: "noopener noreferrer" },
        React__default["default"].createElement("svg", { stroke: "currentColor", fill: "currentColor", strokeWidth: "0", viewBox: "3 3 18 18", height: "1em", width: "1em", className: "ch-browser-open-icon", xmlns: "http://www.w3.org/2000/svg" },
...
function MiniBrowserWithRef(_a, ref) {
    ...
    return (React__default["default"].createElement(MiniFrame, Object.assign({}, props, { zoom: zoom, className: `ch-mini-browser ${props.className || ""}`, style: Object.assign(Object.assign({}, transitionStyle({ progress, transition })), props.style), titleBar: React__default["default"].createElement(TitleBar, { url: displayUrl, linkUrl: loadUrl }) }), children || React__default["default"].createElement("iframe", { ref: ref, src: loadUrl })));
}
...
function Preview(_a) {
    ...
    return (React__default["default"].createElement("div", { className: "ch-preview" + (className ? " " + className : ""), style: style, "data-ch-theme": codeConfig === null || codeConfig === void 0 ? void 0 : codeConfig.themeName }, frameless ? (kids) : (React__default["default"].createElement(MiniBrowser, Object.assign({ loadUrl: show }, rest, { children: kids })))));
}
...
function Spotlight(_a) {
    ...
    return (React__default["default"].createElement("section", { className: `ch-spotlight ${withPreview ? "ch-spotlight-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": codeConfig.themeName },
        ...
        React__default["default"].createElement("div", { className: "ch-spotlight-sticker" },
            ...
            presetConfig ? (React__default["default"].createElement(Preview, { className: "ch-spotlight-preview", files: tab.files, presetConfig: presetConfig })) : hasPreviewSteps ? (React__default["default"].createElement(Preview, Object.assign({ className: "ch-spotlight-preview" }, previewChildren[state.stepIndex]["props"]))) : null)));
}
...
function StaticScrollycoding(_a) {
    ...
    const { stepsChildren, previewChildren } = extractPreviewSteps(children, hasPreviewSteps);
    return (React__default["default"].createElement("section", { className: "ch-scrollycoding-static", "data-ch-theme": (_b = rest === null || rest === void 0 ? void 0 : rest.codeConfig) === null || _b === void 0 ? void 0 : _b.themeName }, stepsChildren.map((children, i) => (React__default["default"].createElement(StaticSection, { key: i, editorStep: editorSteps[i], previewStep: previewChildren && previewChildren[i], allProps: rest }, children)))));
}
...
function DynamicScrollycoding(_a) {
    ...
    return (React__default["default"].createElement("section", { className: `ch-scrollycoding ${withPreview ? "ch-scrollycoding-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": codeConfig === null || codeConfig === void 0 ? void 0 : codeConfig.themeName },
        React__default["default"].createElement("div", { className: "ch-scrollycoding-content" },
            React__default["default"].createElement(Scroller, { onStepChange: onStepChange, triggerPosition: codeConfig === null || codeConfig === void 0 ? void 0 : codeConfig.triggerPosition }, stepsChildren.map((children, i) => (React__default["default"].createElement(Step, { as: "div", key: i, index: i, onClick: () => onStepChange(i), className: "ch-scrollycoding-step-content", "data-selected": i === state.stepIndex ? "true" : undefined },
        ...
        React__default["default"].createElement("div", { className: "ch-scrollycoding-sticker" },
            ...
            presetConfig ? (React__default["default"].createElement(Preview, { className: "ch-scrollycoding-preview", files: tab.files, presetConfig: presetConfig })) : hasPreviewSteps ? (React__default["default"].createElement(Preview, Object.assign({ className: "ch-scrollycoding-preview" }, previewChildren[state.stepIndex]["props"]))) : null)));
}
...
function Slideshow(_a) {
    ...
    return (React__default["default"].createElement("div", { className: `ch-slideshow ${withPreview ? "ch-slideshow-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": codeConfig.themeName },
        React__default["default"].createElement("div", { className: "ch-slideshow-slide" },
            ...
            presetConfig ? (React__default["default"].createElement(Preview, { className: "ch-slideshow-preview", files: tab.files, presetConfig: presetConfig })) : hasPreviewSteps ? (React__default["default"].createElement(Preview, Object.assign({ className: "ch-slideshow-preview" }, previewChildren[currentIndex]["props"]))) : null),
...
function MultilineMark({ children, data, style, lines, }) {
    ...
    return (React__default["default"].createElement("div", { style: style, className: className },
        React__default["default"].createElement("span", { className: "ch-code-multiline-mark-border" }),
        children,
        React__default["default"].createElement(CopyButton, { className: "ch-code-button", content: content })));
}
...
function InlineMark({ children, data }) {
    ...
    return (React__default["default"].createElement("span", { className: className, style: {
...
function Box({ children, data }) {
    ...
    return (React__default["default"].createElement("span", { className: "ch-code-box-annotation", style: { outlineColor } }, children));
}
function WithClass({ children, data, style, }) {
    return (React__default["default"].createElement("span", { style: style, className: data }, children));
}
function Label({ children, data, style }) {
    return (React__default["default"].createElement("div", { className: "ch-code-label-annotation", style: style },
        children,
        React__default["default"].createElement("div", { className: "ch-code-label-annotation-text" }, (data === null || data === void 0 ? void 0 : data.children) || data)));
}
...
function InlineCode(_a) {
    ...
    return (React__default["default"].createElement("span", Object.assign({ "data-ch-theme": codeConfig.themeName, className: "ch-inline-code not-prose" +
            (className ? " " + className : "") }, rest),
        React__default["default"].createElement("code", null, allTokens.map((token, j) => (React__default["default"].createElement("span", Object.assign({ key: j }, token.props), token.content))))));
}
