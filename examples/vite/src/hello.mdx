...
{props.loremPlaceholder}
{props.ipsumPlaceholder}

<CH.Code transformCopyContent={(content) => content.replace('{{LOREM}}', props.loremPlaceholder).replace('{{IPSUM}}', props.ipsumPlaceholder)}>
```javascript
const lorem = {{LOREM}} ipsum
const ipsum = {{IPSUM}} lorem
```
 </CH.Code> 
{/*  
Lorem ipsum dolor sit amet.
